...
CREATE USER kh_cmh IDENTIFIED BY kh1234;
-- 계정 생성 구문 (kh_cmh : USERNAME / kh1234 : Password)
-- ORA-65096: 공통 사용자 또는 롤 이름이 부적합합니다.
-- ORA-01920: 사용자명 'KH_CMH'(이)가 다른 사용자나 롤 이름과 상충됩니다

GRANT RESOURCE, CONNECT TO kh_cmh;
-- 사용자 계정에 권한 부여 설정
-- RESOURCE : 테이블이나 인덱스 같은 DB 객체를 생성할 권한
-- CONNECT : DB에 연결하고 로그인 할 수 있는 권한

ALTER USER kh_cmh DEFAULT TABLESPACE SYSTEM QUOTA
UNLIMITED ON SYSTEM;
